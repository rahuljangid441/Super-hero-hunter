...
function getSearchedSuperHeroes(){
    ...
    <h1 class = "loading-and-error-font"> 
    </h1>
`;
    ...
    let url = 'https://superheroapi.com/api.php/105434235801010/search/'+searchBar.value;
...
apiRequest.onreadystatechange = function(){
    ...
    if(this.readyState == 4 && this.status == 200){
        ...
        if(data.response==="error"){
            displaySearchedHeroesResult.innerHTML = '<h2 class = "loading-and-error-font"> No such element for searched hero </h2> ';
            return;
        ...
        for(let hero of data.results){
            ...
            imageOfHero.setAttribute(
                "src",
                hero.image.url ?? "default-image.jpeg"
              );
